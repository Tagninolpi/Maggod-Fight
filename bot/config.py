...
class Config:
    ...
    LOBBY_CATEGORY_ID = [1407088161364115682,1444237534979817653,1445080816970629140,1464164865869484062]
    ...
    allowed_channel_id = [1407094327573872723,1444237869492207668,1445081294190153769]# channel to use /create /delete (lobby) tutorial
